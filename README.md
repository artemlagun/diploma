...
#### create Votes
`curl -s -X POST http://localhost:8080/api/admin/votes/100004/?userId=100003 --user admin@gmail.com:admin`

#### update Votes 100023
`curl -s -X PUT http://localhost:8080/api/admin/votes/100023/100004 --user admin@gmail.com:admin`
...
`curl -s -X POST http://localhost:8080/api/profile/votes/100004 --user alicerussell@gmail.com:password`

#### update Votes 100022 by user 100000
`curl -s -X PUT http://localhost:8080/api/profile/votes/100022/100005 --user evahester@gmail.com:password`
<br>
<br>
